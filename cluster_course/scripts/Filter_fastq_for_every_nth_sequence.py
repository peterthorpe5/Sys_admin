#s script uses Biopython magic to iterate through a fastq file
...
python Filter_fastq_for_every_nth_sequence.py -i infile.fastq -n
every_n_number_of_seq -o outfile
